...
from deepspeed import ops as dsops


__all__ = ['create_optimizer']


def create_optimizer(name, msg=True):
    if msg:
    ...
    if name.lower() == 'lamb':
        ...
        return dsops.adam.FusedAdam
    elif name.lower() == 'deepspeedcpuadam':
        return dsops.adam.DeepSpeedCPUAdam
    else:
